        ...
        if (docSnapshot.exists()) {
          ...
          axios
            ...
            .then((response) => {
              ...
              const place = `https://maps.googleapis.com/maps/api/place/details/json?place_id=${placeId}&key=${process.env.REACT_APP_API_KEY}`;
  ...
  return (
    <div>
      <div className="view-place-container">
        ...
        <div className="view-place-sub-container">
